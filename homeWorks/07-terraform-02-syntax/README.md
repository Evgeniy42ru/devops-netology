...
1. С помощью [Packer](https://www.packer.io/)

1. https://github.com/Evgeniy42ru/devops-netology/tree/main/terraform

``` shell
Evgeniy@Evgenijs-MacBook-Pro terraform % make terraform-plan                      
