...
![jenkins_is_ready](./src/HW-09-ci-04-01.png)

4. >Сделать первоначальную настройку.

- Установил плагин `Command Agent Launcher Plugin`
- Подключил ноду `agent`
![jenkins_is_ready](./src/HW-09-ci-04-02.png)
...
- Конфигурация
    - `Source Code Management`
        - `git` = true
        -  `Repository URL` = https://github.com/Evgeniy42ru/vector-role.git
...
Cloning repository https://github.com/Evgeniy42ru/vector-role.git
 > git init /opt/jenkins_agent/workspace/freestyle # timeout=10
Fetching upstream changes from https://github.com/Evgeniy42ru/vector-role.git
 > git --version # timeout=10
 > git --version # 'git version 1.8.3.1'
 > git fetch --tags --progress https://github.com/Evgeniy42ru/vector-role.git +refs/heads/*:refs/remotes/origin/* # timeout=10
 > git config remote.origin.url https://github.com/Evgeniy42ru/vector-role.git # timeout=10
...
/bin/sh: ansible-lint.: command not found
```
Непонятно почему он не видет `ansible-lint` установку делал из под юзера `jenkins`
```shell
[evgeniy@jenkins-agent freestyle]$ ansible-lint --version
...
#### Делаем Declarative Pipeline Job:
- На странице `Dashboard` нажимаем `New Item`
...
#### Сосздал в корне репозитория [Jenkinsfile](https://github.com/Evgeniy42ru/vector-role/blob/main/Jenkinsfile)
```jenkins
pipeline {
    agent any
...
```shell
Started by user admin
Obtained Jenkinsfile from git https://github.com/Evgeniy42ru/vector-role.git
...
- Конфигурация
    - `Branch Sources`
        - `Repository HTTPS URL` = `https://github.com/Evgeniy42ru/vector-role.git`
            - `SCM` = `git`
                - `Repository URL` = `https://github.com/Evgeniy42ru/vector-role.git`
    - `Build Configuration`
        - `Mode`= `by Jenkinsfile`
...
Fetching upstream changes from https://github.com/Evgeniy42ru/vector-role.git
 > git --version # timeout=10
 > git --version # 'git version 1.8.3.1'
 > git fetch --no-tags --progress https://github.com/Evgeniy42ru/vector-role.git +refs/heads/main:refs/remotes/origin/main # timeout=10
 > git config remote.origin.url https://github.com/Evgeniy42ru/vector-role.git # timeout=10
...
![parametr](./src/HW-09-ci-04-03-parametr.png)
...
- Репозиторий с ролью - https://github.com/Evgeniy42ru/vector-role
- Declarative Pipeline - https://github.com/Evgeniy42ru/vector-role/blob/main/Jenkinsfile
